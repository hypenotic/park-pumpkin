<template v-if="this.$store.state.locationList != null">
    <section class="filter" >
        ...
        <ul class="map-type">
            <li id="map-view-trigger" v-on:click="listTrigger" class="view-trigger" v-if="this.$store.state.listViewState"><img src="https://parkpeople.ca/pumpkinparades/src/assets/map-trigger-white.svg" alt="orange map icon"></li>
            <li id="map-view-trigger" v-on:click="listTrigger" class="view-trigger" v-else><img src="https://parkpeople.ca/pumpkinparades/src/assets/map-trigger.svg" alt="white map icon"></li>
