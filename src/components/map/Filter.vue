<template v-if="this.$store.state.locationList != null">
    <section class="filter" >
        ...
        <ul class="map-type">
            <li id="map-view-trigger" v-on:click="listTrigger" class="view-trigger" v-bind:class="[this.$store.state.listViewState ? '' : 'active-trigger']"><img src="https://parkpeople.ca/parades/src/assets/map-trigger.svg" alt=""></li>
